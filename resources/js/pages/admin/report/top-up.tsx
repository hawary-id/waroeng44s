...
import { BreadcrumbItem, TopUpWithRelations } from '@/types';
import { Head, Link, useForm } from '@inertiajs/react';
import { Info, Printer, RefreshCcw, SearchIcon } from 'lucide-react';
import { useState } from 'react';
import { columns } from '../top-up/columns';
...
export default function TopUp({ topUps, filters }: IndexProps) {
    ...
    const handlePrint = () => {
        ...
        const url = route('admin.reports.top-up', {
            start_date: data.start_date,
            end_date: data.end_date,
            print: 1,
        });
            ...
            <div className="p-4">
                <div className="mb-5 flex flex-col gap-3 md:flex-row">
                    ...
                    <div className="flex justify-end gap-2 md:mt-6">
                        ...
                        <Link href={route('admin.reports.top-up')}>
                ...
                {topUps && topUps.length > 0 ? (
                    <DataTable showHeaderTable={false} columns={columns(false)} data={topUps} />
                ) : (
