...
export default function Edit({ store }: { store: Store }) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Edit',
            href: '/admin/stores/edit',
        },
    ];
    const { data, setData, put, processing, errors } = useForm<Required<Store>>({
        id: store.id,
        code: store.code,
        name: store.name,
                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                ...
                                <AlertDialogFooter>
                                    ...
                                    <AlertDialogAction onClick={() => put(route('admin.stores.update', store.id))} disabled={processing}>
                                        Ya, Simpan
                                    </AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
