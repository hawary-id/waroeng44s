...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Divisi Baru',
        href: '/admin/divisions/add',
    },
];

export default function Create() {
    const { data, setData, post, processing, errors } = useForm<Partial<Division>>({
        name: '',
    });
                            ...
                            <AlertDialogContent>
                               <AlertDialogHeader>
                                ...
                                <AlertDialogFooter>
                                    ...
                                    <AlertDialogAction onClick={() => post(route('admin.divisions.store'))} disabled={processing}>
                                        Ya, Simpan
                                    </AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
