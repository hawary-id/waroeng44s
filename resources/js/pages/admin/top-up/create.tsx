...
export default function Create({ memberCard }: Props) {
        ...
        if (value.length === 16) {
            try {
                ...
                setData((prevData) => ({
                    ...
                    user_id: String(memberCard.user?.id),
                    user_name: memberCard.user?.name || '',
                    email: memberCard.user?.email || '',
                    division_name: memberCard.user?.division?.name || '',
                    store_name: memberCard.user?.store?.name || '',
    ...
    function handleAmountChange(e: React.ChangeEvent<HTMLInputElement>) {
        ...
        const newBalance = Number(numericValue) + balance;
        setData((prevData) => ({
            ...prevData,
            amount: numericValue,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <form className="flex justify-center py-5">
                <Card className="w-full md:w-1/2">
                    <CardHeader>
                        <CardTitle>Isi Saldo Member Card</CardTitle>
                    ...
                    <CardFooter className="flex justify-between">
                        <Link href={route('admin.top-ups.index')}>
                            <Button type="button" variant="outline">
                                Kembali
                            </Button>
                        </Link>
                        <div className="flex items-center gap-4">
                            <Link href={route('admin.top-ups.create')}>
                            ...
                            <AlertDialog>
                                ...
                                <AlertDialogContent>
                                    ...
                                    <AlertDialogFooter>
                                        ...
                                        <AlertDialogAction onClick={() => post(route('admin.top-ups.store'))} disabled={processing}>
                                            Ya, Simpan
                                        </AlertDialogAction>
                                    </AlertDialogFooter>
                                </AlertDialogContent>
