...
export const columns = (showActions: boolean = true): ColumnDef<TopUpWithRelations>[] => {
    const columns: ColumnDef<TopUpWithRelations>[] = [
        {
            accessorKey: 'code',
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                return formatedDate(expiredDate, 'yyyy-MM-dd HH:mm:ss');
            },
        },
        {
...

        {
            ...
            cell: ({ row }) => {
                ...
                return <Badge variant={badgeVariant}>{transactionStatus[status]}</Badge>;
            },
        },
    ];
                    ...
                    <>
                        ...
                        <AlertDialog open={dialogApproveOpen} onOpenChange={setDialogApproveOpen}>
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>Tindakan ini akan merubah perhitungan saldo.</AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                                    ...
                                    <AlertDialogAction
                                        ...
                                        onClick={() => {
                                            ...
                                            put(route('admin.top-ups.approve', topUp.id));
                                        }}
                                    >
                                        Ya, Approve
                                    </AlertDialogAction>
                        ...
                        <AlertDialog open={dialogOpen} onOpenChange={setDialogOpen}>
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    <AlertDialogTitle>Apakah Anda benar-benar yakin?</AlertDialogTitle>
                                    <AlertDialogDescription>Tindakan ini akan membatalkan transaksi top up saldo.</AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                                    ...
                                    <AlertDialogAction
                                        ...
                                        onClick={() => {
                                            setDialogOpen(false);
                                            destroy(route('admin.top-ups.destroy', topUp.id));
                                        }}
                                    >
                                        Ya, Cancel
                                    </AlertDialogAction>
